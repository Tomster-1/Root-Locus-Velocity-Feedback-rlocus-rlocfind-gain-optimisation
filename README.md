...
> ⚠️ Note: You may see another intersection with \(\zeta=0.707\) at a different \(K\) (e.g. around 11.4), but it can correspond to a **non-dominant** complex pair. The script targets the **dominant complex poles**, which is typically what the design requirement implies.
